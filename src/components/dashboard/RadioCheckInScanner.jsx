  ...
  return (
    <>
      <button
        ...
        className="w-full bg-[#1a2744] border border-[rgba(212,168,67,0.15)] hover:border-[#d4a843]/40 rounded-xl p-4 flex items-center gap-3 transition-all text-left">
        ...
        <div>
          ...
          <p className="text-slate-400 text-xs text-center">Scan QR code to check a radio in or out</p>
        </div>
      </button>
